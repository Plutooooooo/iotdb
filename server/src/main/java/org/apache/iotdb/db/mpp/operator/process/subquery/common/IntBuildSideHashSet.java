...
public class IntBuildSideHashSet extends BuildSideHashSet {

  private IntBigArray values;
  private IntBigArray elementIds;
  private IntBigArray valuesByElementId;
   ...
   */
  public IntBuildSideHashSet(int hashChannel, int estimatedElementCount) {
    ...
    valuesByElementId = new IntBigArray();
  ...
  private int addNewElement(int hashPosition, int value) {
    // record element id
  ...
  protected boolean tryRehash() {
    ...
    IntBigArray newValues = new IntBigArray();
    ...
    for (int elementId = 0; elementId < nextElementId; elementId++) {
      ...
      int value = valuesByElementId.get(elementId);
  ...
  private int getHashPosition(int value, int mask) {
    return Integer.hashCode(value) & mask;
  }
